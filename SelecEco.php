...
<body>
    ...
    <main>
        <div class="Histori">
            <a href="PagIni.php">Inicio</a> > <a href="AgendHoraImg.php">Agenda horas imagenología</a> > <a href="SelecEco.php">Selección de examen</a>
        </div>
        <?php
        $sql="SELECT * FROM exam_img_eco";
        $resul=mysqli_query($conn, $sql);
        while ($row=mysqli_fetch_array($resul)){
            echo "<div class='Botones'>
                    <form action='SelecFechaEco.php' method='post'>
                        <button class='btn btn-primary' type='submit' name='ExaEco'>
                            <div>
                                <input type='hidden' name='NomEco' value='{$row["NomExamen"]}'>
