...
<body>
    ...
    <main>
        <div class="Histori">
            <a href="PagIni.php">Inicio</a> > <a href="AgendHoraImg.php">Agenda horas imagenología</a> > <a href="SelecReso.php">Selección de examen</a>
        </div>
        <div class='MensRecord'><span style='color:red;'>Importante:</span> Pacientes con marcapasos o prótesis metálicas tienen que consultar con tecnólogos si se pueden realizar resonancias magnéticas.</div><br>
        <?php
        $sql="SELECT * FROM exam_img_reso";
        $resul=mysqli_query($conn, $sql);
        while ($row=mysqli_fetch_array($resul)){
            echo "<div class='Botones'>
                    <form action='SelecFechaReso.php' method='post'>
                        <button class='btn btn-primary' type='submit' name='ExaReso'>
                            <div>
                                <input type='hidden' name='NomReso' value='{$row["NomExamen"]}'>
