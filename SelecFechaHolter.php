...
<body>
    ...
    <main>
        <div class="Histori">
            <a href="PagIni.php">Inicio</a> > <a href="AgendHoraLab.php">Agenda exámenes laboratorio</a> > <a href="SelecFechaHolter.php">Selección de fecha</a>
        </div>
        <h1></h1>
        ...
        echo "<script src='https://embed.ycb.me'	async='true'	data-domain='projc-mejoholter'	data-displaymode='auto' ></script>"
        ?>
    </main>
    <footer>
