...
<body>
    ...
    <main>
        <div class="Histori">
            <a href="PagIni.php">Inicio</a> > <a href="AgendHoraMedi.php">Agenda horas médicas</a> > <a href="SelecMedi.php">Seleción de médico</a> > <a href="SelecFechaMedi.php">Seleción de fecha</a>
        </div>
        ...
        if(isset($_POST['Medic'])){
            $DatoClav=$_POST['NomMedi'];
            $DatoClav=str_replace(' ', '-', $DatoClav);
            $nomMedi=$_POST["NomMedi"];
            $nomEspec=$_POST["NomEspec"];

        }
        echo "<script src='https://embed.ycb.me'	async='true'	data-domain='projc-mejo$DatoClav'	data-displaymode='auto'></script>"
        ?>
    </main>
    <footer>
