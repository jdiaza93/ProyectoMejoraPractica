...
<body>
    ...
    <main>
        <div class="Histori">
            <a href="PagIni.php">Inicio</a> > <a href="AgendHoraImg.php">Agenda horas imagenología</a> > <a href="SelecTac.php">Selección de examen</a> > <a href="SelecFechaTac.php">Selección de fecha</a>
        </div>
        ...
        <?php
        if(isset($_POST['ExaTac'])){
            $NomExaTac=$_POST['NomTac'];
        }
        echo "<script src='https://embed.ycb.me'	async='true'	data-domain='projc-mejotac'	data-displaymode='auto' ></script>"
        ?>
    </main>
    <footer>
