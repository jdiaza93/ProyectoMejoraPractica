...
<body>
    ...
    <main>
        <div class="Histori">
            <a href="PagIni.php">Inicio</a> > <a href="AgendHoraImg.php">Agenda horas imagenología</a> > <a href="SelecFechaDensi.php">Selección de fecha</a>
        </div>
        ...
        echo "<script src='https://embed.ycb.me'	async='true'	data-domain='projc-mejodensi'	data-displaymode='auto' ></script>"
        ?>
    </main>
    <footer>
