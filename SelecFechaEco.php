...
<body>
    ...
    <main>
        <div class="Histori">
            <a href="PagIni.php">Inicio</a> > <a href="AgendHoraImg.php">Agenda horas imagenología</a> > <a href="SelecEco.php">Selección de examen</a> > <a href="SelecFechaEco.php">Selección de fecha</a>
        </div>
        ...
        <?php
        if(isset($_POST['ExaEco'])){
            $NomExaEco=$_POST['NomEco'];
        }
        echo "<script src='https://embed.ycb.me'	async='true'	data-domain='projc-mejoeco'	data-displaymode='auto' ></script>"
        ?>
    </main>
    <footer>
